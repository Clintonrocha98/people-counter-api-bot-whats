import { statusCode } from "../errorHandler/statusCode/status-code.js";
import { errorNamesToStatusCode } from "./enums/error-name-table.js";
 ...
 * @param {string} params.name - The name of the error or a StatusCodeKey representing the HTTP status code.
 ...
 */
export function errorHandler({ message, stack, name }) {
  const isDebugMode = process.env.DEBUG_MODE === "true";

  const code =
    errorNamesToStatusCode[name] || null;
